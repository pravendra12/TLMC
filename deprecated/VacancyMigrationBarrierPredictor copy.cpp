    ...
    for (size_t id1 = 0; id1 < numLattices; ++id1)
    {
      ...
      for (auto &id2 : id1FirstNN)
      {
            ...
            symmetricallySortedVectorMap.find(latticePair2) == symmetricallySortedVectorMap.end())
        {
          ...
          auto symmetricallySortedVector1 = config.GetSortedLatticeVectorStateOfPair(latticePair1, maxBondOrder);
          auto symmetricallySortedVector2 = config.GetSortedLatticeVectorStateOfPair(latticePair2, maxBondOrder);
