...
void ClusterExpansionCalculator::print(int index)
{
    // int index = 11;
    auto requiredLocalOrbits = _localOrbitlists[_indexToOffset[index]];


    auto  variable =  _clusterSpace.getClusterVectorFromOrbitListCheck(requiredLocalOrbits, _supercell, index);
